# Keypoint R-CNN (jitter + multi-vehicle)

`kprcnn-jitter-mv` · created 2026-07-26 · weights `kprcnn-jitter-mv.pt`
...
- **Data:** trained on 411 vehicles across 14 scenes; held out 4 untrained scene(s) for testing (below).
...
|---|---:|---:|---:|---:|
| `Centralia_01_20260511` | 56 | 1.0 | 0.70 / 0.47 | **0.56** |
| `Tacoma-Centralia_01_20260429` | 80 | 0.988 | 0.60 / 0.41 | **0.49** |
| `EllensburgPreferredTest_01_20260530` | 2 | 1.0 | 1.00 / 0.01 | **0.03** |
| `Stanwood_10_20260511` | 6 | 1.0 | 0.67 / 0.10 | **0.17** |

**Mean across held-out scenes: centered 0.997 · full-scene F1 0.312.**
