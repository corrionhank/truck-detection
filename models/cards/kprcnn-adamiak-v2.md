# Keypoint R-CNN (Adamiak v2, 12-scene)

`kprcnn-adamiak-v2` · created 2026-07-20 · weights `kprcnn-adamiak-v2.pt`
...
- **Data:** trained on 228 vehicles across 9 scenes; held out 3 untrained
  scene(s) for testing (below). Training scenes: `Bellingham_01_20260425`, `Centralia_01_20260511`, `Centralia_02_20260511`, `Ellensburg-Yakima_01_20260409`, `EllensburgPreferredTest_01_20260530`, `Ellensburg_01_20260504`, `Stanwood_10_20260511`, `Tacoma-Centralia_02_20260602`, `blaine-bellingham_01_20260425`.
...
|---|---:|---:|---:|---:|
| `Tacoma-Centralia_01_20260429` | 80 | 1.0 | 0.56 / 0.52 | **0.54** |
| `auburn-snoqualmie_01_20260425` | 24 | 0.958 | 0.88 / 0.54 | **0.67** |
| `Yakima-Toppenish_01_20260503` | 25 | 0.96 | 0.36 / 0.13 | **0.19** |

**Mean across held-out scenes: centered 0.973 · full-scene F1 0.467.** Cross-*corridor* scenes (a
