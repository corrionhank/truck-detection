# Keypoint R-CNN (no jitter, 20-scene, partial-vehicle fix)

`kprcnn-nojitter-v1` · created 2026-08-21 · weights `kprcnn-nojitter-v1.pt`
...
|---|---:|---:|---:|---:|
| `Tacoma-Centralia_01_20260429` | 80 | 1.0 | 0.59 / 0.39 | **0.47** |

**Mean across held-out scenes: centered 1.0 · full-scene F1 0.47.**
